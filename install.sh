...
validate_inputs() {
  ...
  if [[ ! "$AUTO_RESET_CHECK_INTERVAL" =~ ^[0-9]{2,4}$ ]] || (( AUTO_RESET_CHECK_INTERVAL < 60 || AUTO_RESET_CHECK_INTERVAL > 3600 )); then
...
ReadWritePaths=$alert_state_dir $auto_reset_state_dir
